...
import kr.ac.kopo.won.bookmarket.domain.CartItem;
...
public class CartController {
    ...
    @GetMapping
    public String requestCart(HttpServletRequest request) {
        System.out.println("Call requestCart");
   ...
   public void addCartByNewItem(@PathVariable("bookId")String bookId, HttpServletRequest request) {
    ...
    public void removeCartByItem(@PathVariable("bookId")String bookId, HttpServletRequest request) {
        ...
        cart.removeCartIem(new CartItem(book));
