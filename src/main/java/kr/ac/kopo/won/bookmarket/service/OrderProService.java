...
public class OrderProService {
    ...
    public Page<Order> listAll(int pageNum, String sortField, String sorDir){
        int pageSize= 5;
        Sort sort = sorDir.equals("asc")? Sort.by(sortField).ascending():Sort.by(sortField).descending();
